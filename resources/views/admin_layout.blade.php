...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <script src="{{ $dir }}js/morris.js"></script>
</head>
...
<body>
    ...
    <script src="{{ $dir }}js/jquery.dcjqaccordion.2.7.js"></script>
    <script src="{{ $dir }}js/scripts.js"></script>
    <script src="{{ $dir }}js/jquery.slimscroll.js"></script>
    <script src="{{ $dir }}js/jquery.nicescroll.js"></script>
    <!--[if lte IE 8]><script language="javascript" type="text/javascript" src="{{ $dir }}js/flot-chart/excanvas.min.js"></script><![endif]-->
    <script src="{{ $dir }}js/jquery.scrollTo.js"></script>
    <!-- morris JavaScript -->
    <script>
    ...
    <!-- calendar -->
    <script type="text/javascript" src="{{ $dir }}js/monthly.js"></script>
